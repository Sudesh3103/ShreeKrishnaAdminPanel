...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      setSuccess('If this email is registered, a password reset link will be sent.');
    }, 1200);
  };
      ...
      <div className="login-container d-flex align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
        <div className="login-card p-4" style={{ maxWidth: 400, width: '100%' }}>
          ...
          <div className="mt-3 text-center">
            <button type="button" className="btn btn-link p-0" style={{color: '#667eea', textDecoration: 'underline'}} onClick={() => navigate('/admin-login')}>
              Back to Login
            </button>
          </div>
        </div>
